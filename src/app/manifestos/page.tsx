...
const manifestos = [
  // { title: 'Quality Policy', file: null },
  {
    ...
    file: "/manifestos/Health and Safety Policy Statement.pdf",
  },
  {
    title: "Environment Policy",
    file: "/manifestos/Environmental Policy Statement.pdf",
  },
  {
    title: "Worker welfare commitment",
    file: "/manifestos/Worker Welfare Commitment.pdf",
  },
  {
    title: "Anti-corruption Policy",
    file: "/manifestos/Anticorruption Policy Statement.pdf",
  },
  {
    ...
    <>
      ...
      >
        <Container maxWidth="xl" sx={{ px: { xs: "1rem", md: "2.5rem" } }}>
          ...
          >
            At messe.ae, we are guided by strong ethical values in everything we
            do. We hold ourselves accountable to the highest standards of
            integrity, fairness, and responsibility — towards people, partners,
            and the planet. Ethical conduct is not just a principle for us, it
            is the foundation of every project we deliver.
          </Typography>
